    ...
    setDrafts((current) => [
      {
        ...
        answer: 'Preparing a clear explanation...',
        status: 'AI draft',
        time: 'Just now',
      },
      ...current,
      ...
      <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-8 items-start">
        <section className="space-y-6">
          <div>
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-white">Ask, solve, and revise every doubt.</h1>
            <p className="text-white/55 text-lg mt-5">Built for the real homework loop: type a doubt, attach a photo, get an AI explanation, and keep a mentor review trail.</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-5 md:p-6">
            ...
            <div className="rounded-3xl bg-black/35 border border-white/10 overflow-hidden">
              <div className="flex items-center gap-3 border-b border-white/10 px-5 py-4">
                ...
                <div>
                  <p className="font-black text-white">EduSpark AI Mentor</p>
                  <p className="text-xs text-white/40">Fast explanation first, teacher review when needed</p>
                </div>
              </div>
              ...
              <textarea
                ...
                placeholder="Type your doubt here. Example: I do not understand why the image is virtual in a convex mirror."
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              [Sparkles, 'AI first answer', 'Get a clean explanation in seconds.'],
              [ShieldCheck, 'Teacher verified', 'Escalate hard doubts to mentors.'],
              [Lightbulb, 'Practice from doubt', 'Turn mistakes into drills.'],
            ].map(([Icon, title, copy]) => {
        ...
        <section className="bg-white/5 border border-white/10 rounded-3xl p-5 md:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
              <p className="text-primary text-xs uppercase tracking-[0.2em] font-black">Recent Doubts</p>
              <h2 className="text-3xl font-black text-white tracking-tight mt-1">Resolution timeline</h2>
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap gap-2 items-center mb-3">
                      <span className="text-[10px] uppercase tracking-[0.2em] font-black text-primary">{item.subject}</span>
                      <span className="text-[10px] uppercase tracking-[0.2em] font-black text-white/35">{item.time}</span>
                      <span className={clsx(
